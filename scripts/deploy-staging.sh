...
# Server-side staging deployment for droplet2.
# Run as deploy on droplet2:
#   /home/deploy/scripts/deploy-staging.sh <app> <branch-or-tag>

usage() {
  cat >&2 <<'EOF'
Usage: deploy-staging.sh <app> <branch-or-tag>
